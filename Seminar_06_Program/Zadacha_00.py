# 00. Напишите программу вычисления арифметического выражения заданного строкой.
...
# попытка разобрать решение увиденное на семинаре 
...
# разбивает справочник на отдельные элементы
