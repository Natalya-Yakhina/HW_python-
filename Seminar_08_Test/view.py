...
def show_menu() -> int:
    ...
    print("6. Обновить данные сотрудника") 
    print("7. Экспортировать данные в формате json") 
    print("8. Экспортировать данные в формате сту") 
    print ("9. Закончить рабо!y") 
    return int(input("Введите номер необходимого действия: "))
...
def get_salary() -> float:
    return float("Введите зарплату сотрудника:")
...
def get_changer() -> int:
    print("\Выберите данные, которые необходимо изменить:") 
