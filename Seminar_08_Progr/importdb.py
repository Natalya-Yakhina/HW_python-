...
def import_to_csv(data, filename): # принимает список словарей, дописывет конвертированные в список данные в существующий файл либо создает новый и записывает в него данные
